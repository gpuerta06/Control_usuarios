...
<?php if($_SESSION['rol']==1 ) { ?>
 ...
 <main class="app-content">
      ...
      <form autocomplete="off" action="?c=usuario&a=Desbloquear" method="post">
              <div class="row">
                         
                    <div class="col-md-6">
                   <div class="form-group">
                      ¿Desea desbloquear al usuario:<strong> <?php echo $datos['usuario']; ?></strong>?
 ...
 <input class="form-control" type="hidden" value="0" name="intento">
